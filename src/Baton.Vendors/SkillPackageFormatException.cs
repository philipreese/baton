...
/// <summary>
/// A canonical skill package failed the format lint or could not be read as one (#1151). The
...
{
    /// <summary>The package directory name — the package's identity (#1151).</summary>
