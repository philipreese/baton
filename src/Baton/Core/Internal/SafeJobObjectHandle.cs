...
/// established) — this is Win32 surface, not the deleted Rust FFI scoped by Architecture Rule 3
/// (<see href="../../../../docs/agents/developing-baton.md"/>); CreateJobObject/AssignProcessToJobObject/
