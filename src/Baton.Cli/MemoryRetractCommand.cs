...
/// </para>
/// <para>
/// <b>It does not run <c>baton memory sync</c>.</b> The projections still carry the entry until sync
/// runs, and the honest handling of that is the same as <c>add</c>'s: print the exact command.
/// </para>
/// </remarks>
public static class MemoryRetractCommand
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await MemoryStore.AppendRetractionsAsync([retraction], retractionsFile, cancellationToken).ConfigureAwait(false);
