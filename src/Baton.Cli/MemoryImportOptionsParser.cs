...
public static class MemoryImportOptionsParser
{
    ...
    [
        ...
        "a vendor-authored file. It writes the per-repository store and one import manifest under",
        "Baton's root, then successful canonical changes project only Baton's generated cache file",
        "into already-discovered markdown roots. Failure leaves a durable daemon retry obligation.",
        "",
