...
def _selftest() -> int:
    ...
    with tempfile.TemporaryDirectory() as ident_tmp:
        ...
        if ident_gate_case is not None:
            ...
            # The daemon now writes this same projection into its file.
            ...
            check("#1557 PR-B2 acceptance: the full posted bodies are identical across sources. "
            ...
            check("#1557 PR-B2 acceptance: both sources carry the same per-room `timelines` entries",
